import pandas as pd
import mtd_data as summary
import plotly.graph_objects as go
from weasyprint import HTML
import os

# Summary of all channels
df_combined = pd.concat([summary.amazon_df, summary.shopify_df], ignore_index=True)
...
tacos_html = summary.tacos_df.to_html(index=False)
engagement_html = summary.engagement_df.to_html(index=False)
